...
-- Created: 2025-12-22
-- Tables Affected:
--   1. ioe.member_devices (production)
--   2. ioe_stg.stg_device_activation_delta (staging)
-- =====================================================================================
...
-- =====================================================================================
-- PART 1: Production Table (ioe.member_devices)
-- =====================================================================================

PRINT '🔧 [PRODUCTION] Renaming column in ioe.member_devices...';
...
BEGIN
    ...
    BEGIN
        -- Rename the column
        EXEC sp_rename
            'ioe.member_devices.battery_status',
            'powersaver_mode',
            'COLUMN';
...
-- =====================================================================================
-- PART 2: Staging Table (ioe_stg.stg_device_activation_delta)
-- =====================================================================================

PRINT '🔧 [STAGING] Renaming column in ioe_stg.stg_device_activation_delta...';
...
BEGIN
    ...
    BEGIN
        -- Rename the column
        EXEC sp_rename
            'ioe_stg.stg_device_activation_delta.battery_status',
            'powersaver_mode',
            'COLUMN';

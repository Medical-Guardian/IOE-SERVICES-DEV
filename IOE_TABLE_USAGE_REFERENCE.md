...
**Comprehensive documentation of all 65 ioe tables with usage details**
...
#### 4. **ioe.member_campaign_enrollments_enhanced**
...
#### 11. **ioe.member_enrollment_status_history**
...
#### 12. **ioe.partner_file_processing_log**
...
#### 13. **ioe.partner_row_validation_results**
...
#### 14. **ioe.partner_validation_error_details_file**
...
#### 15. **ioe.partner_validation_error_details_row**
...
#### 16. **ioe.partner_file_care_gap_stats**
...
**Files:** 1 Python file
**Operations:** Referenced as constant (ERROR_LOG_TABLE = "ioe.error_log"), not actively used
...
#### 22. **ioe.bland_sms_communications**
...
The following 42 tables exist in the ioe schema but have **NO references** in the IOE-functions codebase. They may be:

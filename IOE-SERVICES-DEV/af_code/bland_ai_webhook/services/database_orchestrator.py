...
class DatabaseOrchestrator:
    ...
    def _build_update_enrollment(
        ...
        if should_transition_to_wellness:
            ...
            get_intro_data_q = """
                SELECT current_status, preferred_window, channel 
            ...
            if intro_data:
                ...
                channel = intro_data[0].get("channel")
                ...
                logger.info(f"📊 [DB-ORCH]   - Channel: {channel}")
            else:
                logger.error(
            ...
            # Step 2: Create/Update wellness campaign to ENROLLED (use preferred_window AND channel from intro)
            wellness_upsert_q = """
            ...
            try:
                ...
                wellness_rows = self.db_service.execute_query(
                    wellness_upsert_q,
                    (member_id, WELLNESS_CAMPAIGN_ID, "ENROLLED", preferred_window, channel),
                    fetch_results=False,
                )
                logger.info(
